    ...
    fields: function fields() {
        return {
            dealjackets: {
                ...
                args: { status: { type: new __WEBPACK_IMPORTED_MODULE_3_graphql__["GraphQLNonNull"](__WEBPACK_IMPORTED_MODULE_3_graphql__["GraphQLString"]) } },
                // args: {
                //     // type: GraphQLString,
                ...
                resolve: function resolve(root, args) {
                    return __WEBPACK_IMPORTED_MODULE_1__models_dealjacket__["a" /* default */].find({ args: args }, function (err, dealjackets) {}).exec();
                }
            }
        };
    }
