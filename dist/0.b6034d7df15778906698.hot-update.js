...
var DealJacketQueryRootType = new __WEBPACK_IMPORTED_MODULE_3_graphql__["GraphQLObjectType"]({
    ...
    fields: function fields() {
        return {
            ...
            //     // }
            //     resolve: (root, args) => DealJacket.find(args.status,function(err, dealjackets){}).exec()
            // }
            // },
            dealjackets: {
                type: new __WEBPACK_IMPORTED_MODULE_3_graphql__["GraphQLList"](DealJacketType),
                args: {
                    type: new __WEBPACK_IMPORTED_MODULE_3_graphql__["GraphQLList"](__WEBPACK_IMPORTED_MODULE_3_graphql__["GraphQLString"]),
                ...
                resolve: function resolve(root, args) {
                    return __WEBPACK_IMPORTED_MODULE_1__models_dealjacket__["a" /* default */].find(args, function (err, dealjackets) {}).exec();
                }
            }
        };
    }
