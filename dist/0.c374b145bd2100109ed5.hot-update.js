...
var DealJacketType = new __WEBPACK_IMPORTED_MODULE_2_graphql__["GraphQLObjectType"]({
  ...
  fields: function fields() {
    return {
      _id: { type: __WEBPACK_IMPORTED_MODULE_2_graphql__["GraphQLString"] },
    ...
    return {
      dealjackets: {
        ...
        resolve: function resolve() {
          __WEBPACK_IMPORTED_MODULE_1__models_dealjacket__["a" /* default */].find({}, function (err, dealjackets) {
            //console.log(err)
            console.log(dealjackets);
            return dealjackets;
          });
        }
      }
